    <div class="container">
			...
			<form method="post" enctype="application/x-www-form-urlencoded" >
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" name="group_name" id="group_name" maxlength="20" value="<?=$user_group->group_name?>" placeholder="<?=@$text_users_group_name?>"  required>
			  </div>
			 ...
			 <div class="form-check">
			  ...
			  <?= in_array($privilege->id , $group_privileges_ids) ? 'checked' : ''?> >
